    ...
    return (
        <div className = "ingredient-list">
                ...
                <div className="add-ingredient-button-container">
                    <button onClick = {e=>handleAddIngredient("ingredients",{portion:"",ingredient:""})}className = "add-ingredient-button"><FontAwesomeIcon icon={faPlus} /></button>
                </div>
            </div>
    );
}
    ...
    return ingredients.map((ingredient,index)=>{
        return (
            <div className="ingredient-container" key = {`ingredient-${ingredient.id}`}>
                <button onClick = {(e) => handleDeleteIngredient(ingredient.id,e,"ingredients")}className = "delete-ingredient-button"><FontAwesomeIcon icon={faMinus} /></button>
