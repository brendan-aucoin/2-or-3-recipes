...
const IngredientList = ({ingredients,handleAddIngredient,handleDeleteIngredient,handleChange})=>{
    return (
        <div className = "make-recipe-ingredient-list">
...
const displayIngredientList = (ingredients,handleDeleteIngredient,handleChange) =>{
    return ingredients.map((ingredient,index)=>{
        return (
            <div className="make-recipe-ingredient-container" key = {`ingredient-${ingredient.id}`}>
                ...
                <input type = "text" placeholder = "portion" onChange = {(e) => handleChange(index,e,"ingredients", "portion")}  className = "make-recipe-portion-field"/>
                <input type = "text" placeholder = "ingredient" onChange = {(e) => handleChange(index,e,"ingredients","ingredient")}  className = "make-recipe-ingredient-field" />
            </div>
        );
    });
}
